...
switch (_type) do
{
	 ...
	 case 5:
	{
		...
		_crate1 setDropInterval 0.01;
		/*
		_bzone = createTrigger ["EmptyDetector", position _base];
		_bzone setTriggerActivation ["ANY", "PRESENT", false];
		_bzone setTriggerArea [150, 150, 0, true ];
		
		_list = list _bzone;
		{
			if(_x isKindof "Man" and (side _x) == east) then {_x setdamage 1};
		} forEach _list;
		*/
		sleep 120.0;
		...
		for [{_loop=0}, {_loop<1}, {_loop=_loop}] do
		{
			...
			_i = 0;
			 ...
			 {		
				...
				sleep 0.5;
				_crate1 setParticleRandom [0, [0.25, 0.25, 0], [0.175, 0.175, 0], 0, 0.25, [0, 0, 0, 0.1], 0, 0];
				_crate1 setParticleParams [["\Ca\Data\ParticleEffects\FireAndSmokeAnim\FireAnim.p3d", 8, 1, 8], "", "SpaceObject", 1, 12.5, [0, 0, 10], [5, 10, -10.75], 0, 10, 7.9, 0.075, [0.3, 0.3, 0.3], [[0.1, 0.9, 0.1, 1], [0.25, 0.25, 0.25, 0.5], [0.5, 0.5, 0.5, 0]], [0.08], 1, 0, "", "", XXXOBJECTXXX];
				sleep 0.5;
				_crate1 setParticleRandom [0, [0.25, 0.25, 0], [0.175, 0.175, 0], 0, 0.25, [0, 0, 0, 0.1], 0, 0];
				_crate1 setParticleParams [["\Ca\Data\ParticleEffects\FireAndSmokeAnim\FireAnim.p3d", 8, 1, 8], "", "SpaceObject", 1, 12.5, [0, 0, 10], [10, 0, -10.75], 0, 10, 7.9, 0.075, [0.3, 0.3, 0.3], [[0.1, 0.1, 0.9, 1], [0.25, 0.25, 0.25, 0.5], [0.5, 0.5, 0.5, 0]], [0.08], 1, 0, "", "", XXXOBJECTXXX];		
				sleep 0.5;
				_crate1 setParticleRandom [0, [0.25, 0.25, 0], [0.175, 0.175, 0], 0, 0.25, [0, 0, 0, 0.1], 0, 0];
				_crate1 setParticleParams [["\Ca\Data\ParticleEffects\FireAndSmokeAnim\FireAnim.p3d", 8, 1, 8], "", "SpaceObject", 1, 12.5, [0, 0, 10], [5, -10, -10.75], 0, 10, 7.9, 0.075, [0.3, 0.3, 0.3], [[0.1, 0.1, 0.9, 1], [0.25, 0.25, 0.25, 0.5], [0.5, 0.5, 0.5, 0]], [0.08], 1, 0, "", "", XXXOBJECTXXX];		
				sleep 0.5;		
				_crate1 setParticleRandom [0, [0.25, 0.25, 0], [0.175, 0.175, 0], 0, 0.25, [0, 0, 0, 0.1], 0, 0];
				_crate1 setParticleParams [["\Ca\Data\ParticleEffects\FireAndSmokeAnim\FireAnim.p3d", 8, 1, 8], "", "SpaceObject", 1, 12.5, [0, 0, 10], [10, 0, -10.75], 0, 10, 7.9, 0.075, [0.3, 0.3, 0.3], [[0.9, 0.1, 0.1, 1], [0.25, 0.25, 0.25, 0.5], [0.5, 0.5, 0.5, 0]], [0.08], 1, 0, "", "", XXXOBJECTXXX];		
				sleep 0.5;
...
XXXPARTICLEEFFECTSOURCEXXX setParticleRandom [0, [10.25, 10.25, 0], [0.175, 0.175, 0], 0, 0.25, [0, 0, 0, 0.1], 0, 0];
XXXPARTICLEEFFECTSOURCEXXX setParticleParams [["\Ca\Data\ParticleEffects\FireAndSmokeAnim\SmokeAnim.p3d", 8, 1, 8], "", "Billboard", 1, 12.5, [0, 0, 0], [0, 0, 0.6], 0, 10.2, 7.9, 0.075, [1.2, 2, 4], [[1, 1, 1, 0.1], [1, 1, 1, 0.1], [1, 1, 1, 0.4]], [0.08], 1, 0, "", "", XXXOBJECTXXX];
XXXPARTICLEEFFECTSOURCEXXX setDropInterval 0.01;
*/
...
XXXPARTICLEEFFECTSOURCEXXX setParticleCircle [0, [0, 0, 0]];
XXXPARTICLEEFFECTSOURCEXXX setParticleRandom [0, [20.25, 100.25, 0], [0.175, 0.175, 0], 0, 0.25, [0, 0, 0, 0.1], 0, 0];
XXXPARTICLEEFFECTSOURCEXXX setParticleParams [["\Ca\Data\ParticleEffects\FireAndSmokeAnim\FireAnim.p3d", 8, 2, 8], "", "Billboard", 1, 12.5, [0, 0, 0], [0, 0, 0.85], 0, 10.2, 7.9, 0.075, [1, 2, 4], [[1, 1, 1, 1], [1, 1, 1, 0.5]], [0.08], 1, 0, "", "", XXXOBJECTXXX];
XXXPARTICLEEFFECTSOURCEXXX setDropInterval 0.003;
*/