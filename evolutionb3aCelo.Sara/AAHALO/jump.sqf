...
_poso = position _obj_jump;
_obj_jump setpos getmarkerpos "halos";
_obj_jump = "SoldierWSaboteurPipe" createVehicleLocal _poso;
_obj_jump setpos _poso;
...
if ((position _obj_jump select 2) < 10 and vehicle player == player) then
{
	player setdamage 1;
	player setpos position _obj_jump;
	deletevehicle _obj_jump;
};
